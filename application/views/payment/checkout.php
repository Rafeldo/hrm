...
<div class="panel panel-custom">
    ...
    <div class="modal-body">
        ...
        <input type="hidden" name="amount" value="<?= display_money($invoice_info['amount']) ?>">
        <input id="token" name="token" type="hidden" value="">

        <div class="form-group">
            <label class="col-lg-4 control-label">Card Number</label>
            <div class="col-lg-5">
                <input type="text" id="ccNo" size="20" class="form-control card-number input-medium" autocomplete="off"
                       placeholder="10111042254564" required>
            </div>
        </div>
