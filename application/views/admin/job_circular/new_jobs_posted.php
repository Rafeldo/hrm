            ...
            <div class="form-group" id="border-none">
                ...
                <div class="col-sm-5">
                    <select class="form-control" name="employment_type">
                        <option value="full_time"><?= lang('full_time') ?></option>
                        <option value="part_time"><?= lang('part_time') ?></option>
                    </select>
                </div>
            </div>
            <div class="form-group" id="border-none">
                ...
                <div class="col-sm-8">
                    <div class="col-sm-4 row">
                        <div class="checkbox-inline c-checkbox">
                            <label>
                                <input <?= (!empty($job_posted->status) && $job_posted->status == 'published' ? 'checked' : ''); ?>
