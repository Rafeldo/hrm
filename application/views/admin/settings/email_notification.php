...
<!--                        <div class="form-group">-->
<!--                            <label for="field-1"-->
<!--                                   class="col-sm-3 control-label">--><?//= lang('performance') . ' ' . lang('email') ?>
<!--                                : <span-->
<!--                                    class="required">*</span></label>-->
<!---->
<!--                            <div class="col-sm-5">-->
<!--                                <input data-toggle="toggle" name="performance_email" value="1" --><?php
//
//                                $performance_email = config_item('performance_email');
//                                if (!empty($performance_email) && $performance_email == 1) {
//                                    echo 'checked';
//                                }
//                                ?><!-- data-on="--><?//= lang('yes') ?><!--" data-off="--><?//= lang('no') ?><!--" data-onstyle="success"-->
<!--                                       data-offstyle="danger" type="checkbox">-->
