                    ...
                    <form role="form" id="form" action="<?php echo base_url(); ?>admin/settings/save_payments/<?= $payment ?>" method="post" class="form-horizontal  ">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">                        
                                    <select name="paypal_status" class="form-control">
                                        <option <?= (config_item('paypal_status') == 'active' ? 'selected' : '') ?> value="active"><?= lang('active') ?></option>
                                        <option <?= (config_item('paypal_status') == 'deactive' ? 'selected' : '') ?> value="deactive" ><?= lang('deactive') ?></option>
                                    </select>                        
                                </div>
                            </div>                                                                             
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">                        
                                    <select name="2checkout_status" class="form-control">
                                        <option <?= (config_item('2checkout_status') == 'active' ? 'selected' : '') ?> value="active"><?= lang('active') ?></option>
                                        <option <?= (config_item('2checkout_status') == 'deactive' ? 'selected' : '') ?> value="deactive" ><?= lang('deactive') ?></option>
                                    </select>                        
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">                        
                                    <select name="stripe_status" class="form-control">
                                        <option <?= (config_item('stripe_status') == 'active' ? 'selected' : '') ?> value="active"><?= lang('active') ?></option>
                                        <option <?= (config_item('stripe_status') == 'deactive' ? 'selected' : '') ?> value="deactive" ><?= lang('deactive') ?></option>
                                    </select>                        
                                </div>
                            </div>
                        <?php elseif ($payment == 'Authorize.net'): ?>
                            <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                    <input type="text" class="form-control" value="<?= $this->config->item('authorize') ?>" name="authorize">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-4 control-label"><?= lang('authorize_transaction_key') ?></label>
                                <div class="col-lg-7">
                                    <input type="text" class="form-control" value="<?= $this->config->item('authorize_transaction_key') ?>" name="authorize_transaction_key">
                                </div>
                            </div> 
                            <div class="form-group">
                                <label class="col-lg-4 control-label"><?= lang('status') ?></label>
                                <div class="col-lg-6">                        
                                    <select name="authorize_status" class="form-control">
                                        <option <?= (config_item('authorize_status') == 'active' ? 'selected' : '') ?> value="active"><?= lang('active') ?></option>
                                        <option <?= (config_item('authorize_status') == 'deactive' ? 'selected' : '') ?> value="deactive" ><?= lang('deactive') ?></option>
                                    </select>                        
                                </div>
                            </div>
                        ...
                        <?php elseif ($payment == 'CCAvenue'):
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                    <input type="text" class="form-control" value="<?= $this->config->item('ccavenue_merchant_id') ?>" name="ccavenue_merchant_id">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-4 control-label"><?= lang('ccavenue_key') ?></label>
                                <div class="col-lg-7">
                                    <input type="text" class="form-control" value="<?= $this->config->item('ccavenue_key') ?>" name="ccavenue_key">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-4 control-label"><?= lang('status') ?></label>
                                <div class="col-lg-6">                        
                                    <select name="ccavenue_status" class="form-control">
                                        <option <?= (config_item('ccavenue_status') == 'active' ? 'selected' : '') ?> value="active"><?= lang('active') ?></option>
                                        <option <?= (config_item('ccavenue_status') == 'deactive' ? 'selected' : '') ?> value="deactive" ><?= lang('deactive') ?></option>
                                    </select>                        
                                </div>
                            </div>
                        ...
                        <?php elseif ($payment == 'Braintree'):
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                    <input type="text" class="form-control" value="<?= $this->config->item('braintree_merchant_id') ?>" name="braintree_merchant_id">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-4 control-label"><?= lang('braintree_private_key') ?></label>
                                <div class="col-lg-7">
                                    <input type="text" class="form-control" value="<?= $this->config->item('braintree_private_key') ?>" name="braintree_private_key">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-4 control-label"><?= lang('braintree_public_key') ?></label>
                                <div class="col-lg-7">
                                    <input type="text" class="form-control" value="<?= $this->config->item('braintree_public_key') ?>" name="braintree_public_key">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-4 control-label"><?= lang('braintree_default_account') ?></label>
                                <div class="col-lg-7">
                                    <input type="text" class="form-control" value="<?= $this->config->item('braintree_default_account') ?>" name="braintree_default_account">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-4 control-label"><?= lang('braintree_live_or_sandbox') ?></label>
                                <div class="col-lg-7">
                                    <input type="text" class="form-control" value="<?= $this->config->item('braintree_live_or_sandbox') ?>" name="braintree_live_or_sandbox">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-4 control-label"><?= lang('status') ?></label>
                                <div class="col-lg-6">                        
                                    <select name="braintree_status" class="form-control">
                                        <option <?= (config_item('braintree_status') == 'active' ? 'selected' : '') ?> value="active"><?= lang('active') ?></option>
                                        <option <?= (config_item('braintree_status') == 'deactive' ? 'selected' : '') ?> value="deactive" ><?= lang('deactive') ?></option>
                                    </select>                        
                                </div>
                            </div>                            
                    </div>
                        ...
                        <table class="table table-striped DataTables " id="Transation_DataTables">
                            ...
                            <tbody>   
                                ...
                                foreach ($payment_method as $v_payments) {
                                    ?>
                                    <tr>
                                        <td><img style="width: 80px;height: 50px" src="<?= base_url() ?>asset/images/payment_logo/<?= $v_payments->icon; ?>"></td>                                                
                                        ...
                                        <td><?php
                                            ...
                                            <?php }
                                            ?></td>                                                
                                        <td><a data-toggle="tooltip" title="<?= lang('edit') ?>" class="btn btn-xs btn-primary" href="<?= base_url() ?>admin/settings/payments/<?= $v_payments->gateway_name ?>"><i class="fa fa-edit"></i></a></td>                                                
                                    </tr> 
                                <?php } ?>
                            </tbody>
                        </table>
