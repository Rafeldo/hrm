...
<div class="row">
    <div class="col-sm-6 wrap-fpanel">
        <div class="panel panel-custom" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form" id="change_password" style="display: initial"
    ...
    <div class="col-sm-6 wrap-fpanel">
        <div class="panel panel-custom" data-collapsed="0">
            ...
            <div class="panel-body">
                <form role="form" id="change_password" action="<?php echo base_url(); ?>admin/settings/set_password"
                ...
                <form role="form" id="change_password" style="display: initial"
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"></label>
                        <div class="col-lg-8">
                            <button type="submit" id="change_username" class="btn btn-sm btn-primary"><?= lang('change_username') ?></button>
                        </div>
                    </div>
                </form>
