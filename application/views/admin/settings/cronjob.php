    ...
    <div class="col-lg-12">
        <form role="form" id="form" action="<?php echo base_url(); ?>admin/settings/save_cronjob"
            ...
            <section class="panel panel-custom">
                <header class="panel-heading  "><?= lang('cronjob') . ' ' . lang('settings') ?></header>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?= lang('automatic') . ' ' . lang('database_backup') ?></label>
                        <div class="col-lg-8">
                            <label class="checkbox-inline c-checkbox">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <p class="form-control-static"><strong><i><?= base_url() ?>cronjob</i></strong></p>
                        </div>
                    </div>
                    <div class="form-group">
