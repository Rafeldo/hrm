<div class="row">
    <div class="col-sm-12" data-spy="scroll" data-offset="0">        
        <div class="panel panel-custom">
            <div class="panel-heading"><div class="panel-title"><?= lang('all_activities'); ?>
                    <a onclick="return confirm('<?= lang('delete_alert') ?>')" href="<?= base_url() ?>admin/settings/clear_activities" class="btn btn-xs btn-primary pull-right"><?= lang('clear') ?></a>
                </div></div>                  
            <div class="row">
                <div class="col-lg-12">                                        
