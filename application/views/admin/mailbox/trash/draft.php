                        ...
                        <table class="table table-striped DataTables " id="DataTables">
                            ...
                            <?php if (!empty($draft_message)):foreach ($draft_message as $v_draft_msg): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url() ?>admin/mailbox/index/read_draft_mail/<?php echo $v_draft_msg->draft_id ?>"><?php
                                            $string = (strlen($v_draft_msg->to) > 13) ? substr($v_draft_msg->to, 0, 10) . '...' : $v_draft_msg->to;
                                            echo $string;;
                                            ?></a></td>
