            ...
            <section class="panel panel-custom">
                <div class="panel-body">
                    <?php if (!empty($can_edit)) { ?>
                        ...
                        <a data-toggle="tooltip" data-placement="top"
                           href="<?= base_url() ?>admin/invoice/manage_invoice/payments_pdf/<?= $payments_info->payments_id ?>"
                           title="<?= lang('pdf') ?>"
                                ...
                                <div style="padding:35px;">
                                    ...
                                    <div style="padding-top:10px">
                                        <div style="width:75%;border-bottom:1px solid #eee;float:right"><strong><a
                                                    href="<?= base_url() ?>admin/client/client_details/<?= $payments_info->paid_by ?>"><?= ucfirst($client_info->name) ?></a></strong>
                                        </div>
                                    ...
                                    <div style="margin-top:100px">
                                        ...
                                        <table style="width:100%;margin-bottom:35px;table-layout:fixed;" cellpadding="0"
                                            ...
                                            <tr style="border-bottom:1px solid #ededed">
                                                ...
                                                <td style="padding: 10px 10px 5px 10px;text-align:right;word-wrap: break-word;"
                                                    valign="top">
                                                    <span><?= display_money($this->invoice_model->get_invoice_cost($payments_info->invoices_id), $currency->symbol); ?>
