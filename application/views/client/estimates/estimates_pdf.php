    ...
    <table style="width: 100%; vertical-align: middle;">
        <tr>
            ...
            <td style="border: 0px;float: right;">
                <small style="float: right;"><?= $language_info['estimate_date'] ?>
                    : <?= strftime(config_item('date_format'), strtotime($estimates_info->date_saved)); ?></small>
            </td>
        </tr>
    </table>
</div>
    ...
    <table style="width: 100%; font-family: Arial, Helvetica, sans-serif; border-collapse: collapse;">
        ...
        <tr style="width: 100%;">
            ...
            <td>
                ...
                <p></p>
                <p><b><?= $language_info['valid_until'] ?>
                        :</b> <?= strftime(config_item('date_format'), strtotime($estimates_info->due_date)); ?></p>
                <?php
            ...
            <table class="table1" style="width: 100%;border:0px">
                ...
                <?php if ($estimates_info->tax > 0.00): ?>
                    <tr>
                        ...
                        <td><?= display_money($this->estimates_model->estimate_calculation('tax', $estimates_info->estimates_id)) ?> </td>
                    </tr>
                <?php endif ?>
                <?php if ($estimates_info->discount > 0) { ?>
                    <tr>
                        <td style="text-align: right">
                            <strong><?= $language_info['discount'] ?> : - <?php echo $estimates_info->discount; ?>
                                %</strong></td>
