                                    ...
                                    <li class="<?= ($v_payments_info->payments_id == $this->uri->segment(5) ? 'active' : '') ?>">
                                        <a href="<?= base_url() ?>client/invoice/manage_invoice/payments_details/<?= $v_payments_info->payments_id ?>">
                                            ...
                                            <div class="pull-right">
                                                <?= display_money($v_payments_info->amount, $v_payments_info->symbol); ?>
                                            </div>
                                            <br>
                                ...
                                <div style="padding:35px;">
                                    ...
                                    <div style="width: 70%;float: left;">
                                        <div style="width: 100%;padding: 11px 0;">
                                            ...
                                            <div
                                                style="width:65%;border-bottom:1px solid #eee;float:right;foat:right;"><?= strftime(config_item('date_format') . " %H:%M:%S", strtotime($payments_info->created_date)); ?></div>
                                            <div style="clear:both;"></div>
                                        </div>
                                    ...
                                    <div style="text-align:center;color:white;float:right;background:#1B9BA0;width: 25%;
                                        ...
                                        <span
                                            ...
                                            <?= display_money($payments_info->amount, $payments_info->symbol); ?>
                                        </span>
                                    </div>
                                    <div style="clear:both;"></div>
                                    ...
                                    <div style="padding-top:10px">
                                        <div style="width:75%;border-bottom:1px solid #eee;float:right"><strong><a
                                                    href="<?= base_url() ?>#<?= $payments_info->paid_by ?>"><?= ucfirst($client_info->name) ?></a></strong>
                                        </div>
                                        <div style="color:#999;width:25%"><?= lang('received_from') ?></div>
                                    </div>
                                    <div style="padding-top:25px">
                                        <div
                                            style="width:75%;border-bottom:1px solid #eee;float:right"><?= $payment_methods->method_name ?></div>
                                        ...
                                        <table style="width:100%;margin-bottom:35px;table-layout:fixed;" cellpadding="0"
                                            ...
                                            <tr style="border-bottom:1px solid #ededed">
                                                ...
                                                <td style="padding: 10px 10px 5px 10px;text-align:right;word-wrap: break-word;"
                                                    valign="top">
                                                    <span>
                                                        <?= display_money($this->invoice_model->get_invoice_cost($payments_info->invoices_id), $payments_info->symbol); ?>
                                                        (- <?= lang('tax') ?>) </span>
                                                </td>
