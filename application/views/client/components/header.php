                    ...
                    <ul class="dropdown-menu animated zoomIn">
                        <li>
                            ...
                            <div class="list-group">
                                ...
                                <!-- list item-->
                                <a href="<?php echo base_url() ?>client/mailbox/index/read_inbox_mail/<?php echo $v_email->inbox_id ?>" class="list-group-item">
                                    <div class="media-box">
                                        <div class="pull-left">
                                            <em class="fa fa-envelope-o fa-2x text-info"></em>
                                        </div>
                                        <div class="media-box-body clearfix">
                                            <p style="color: #555555;" class="m0"><?= (strlen($v_email->subject) > 25) ? substr($v_email->subject, 0, 25) . '...' : $v_email->subject; ?></p>
                                ...
                                <a href="#" class="list-group-item">
                                    <small style="color: #555555;"> <?= lang('you_have') ?>  <?= lang('messages') ?></small>
