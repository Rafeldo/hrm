...
class User extends Admin_Controller
{
    ...
    {
        $data = $this->user_model->array_from_post(array('joining_date', 'gender', 'date_of_birth', 'maratial_status', 'father_name', 'mother_name', 'phone', 'mobile', 'skype', 'present_address'));
    ...
    public function send_welcome_email($id)
    {
        ...
        $message = str_replace("{SITE_NAME}", config_item('company_name'), $NAME);
